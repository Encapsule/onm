// future-data-model-decl.js
// ============================================================================

/*

  - onm vXXX data model declarations must be valid JSON to support transfer over the wire
...
var dataModelDescriptor = {
    ...
    label: 'onm Address Book Data Model',

    // 'description'
    // required string property
    // short explanation of the purpose of the data model, the type(s) of data it models.
    description: 'Demonstrates new features and syntax of onm data model descriptor object format.',
    ...
    namespaceDescriptor: {
        name: 'addressBook'
        label: 'Address Book',
        description: 'An example onm data model for a hypothetical address book data set.',
        type: 'descriptor',
